...
import Paymentsucces from "./PaymentStatusCom";
          ...
          <Grid container>
            <Grid container item xs={12} className="successpagecontainer">
              <Grid item xs={2} align="center ">
                <Typography className="whitecolortypo">Product </Typography>{" "}
                <img src={elden} className="suucimg" />
              </Grid>
              <Grid item xs={4}>
                ...
                <Button className="whitebutton statusbutton">
                  Status :{" "}
                  <span>
                    <Paymentsucces />
                  </span>
              ...
              <Grid container item xs={12} className="pricecontainer">
                ...
                <Grid item xs={6}>
                  <Typography className="whitecolortypo">
                    ...
                    <span className="greencolortypo ml10px"> 04:55 </span>
                  </Typography>{" "}
                </Grid>
